...
namespace TerrariaNextbot.Items
{
	...
	public class NextbotSummoner : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Gigachad Nextbot Summon Item");
			Tooltip.SetDefault("Summons Gigachad Nextbot");
		...
		// 	return !NPC.AnyNPCs(ModContent.NPCType<Gigachad>());
		// }
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				SoundEngine.PlaySound(new SoundStyle($"{nameof(TerrariaNextbot)}/SFX/Gmod-menu-sound"));
				
				int type = ModContent.NPCType<Gigachad>();
